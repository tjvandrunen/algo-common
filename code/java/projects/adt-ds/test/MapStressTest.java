...
public abstract class MapStressTest extends MapRemoveTest {
    ...
    public void fullyPopulateThenRemove() {
        ...
        resetInteger();
        // populate testMapInt with 100 keys and values
        // (which is the default initial capacity of ArrayMap
        for (int i = 0; i < 100; i++) {
            testMapInt.put(i, i);
        } 
        ...
        // check that the internal rearrangment of associations preserves
        // all keys that aren't removed
        Iterator<Integer> it = testMapInt.iterator();
