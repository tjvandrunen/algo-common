...
public class ArrayMap<K, V> implements Map<K, V> {
     ...
     */
    protected static class Association<K, V> {
        K key;
        V val;
     ...
     */
    protected Association<K,V>[] internal;
    ...
    /**
     * Determine whether a given index contains a given key
     * @param key The key to test
     * @param index The index to test
     * @return True if index is valid and contains key, false otherwise.
     */
    protected boolean indexContainsKey(K key, int index) {
        return index >= 0 && index < size && internal[index].key.equals(key);
    }
