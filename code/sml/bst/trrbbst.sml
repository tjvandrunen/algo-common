...
struct
  ...
  val newMap = Null;
   ...
   fun putFixup(Node(Black, ka, va, 
                     Node(Red, kl, vl, 
                          alpha, Node(Red, klr, vlr, beta, gamma)),
                     Node(Red, kr, vr, delta, epsilon))) =
             Node(Red, ka, va, 
                  Node(Black, kl, vl, alpha, Node(Red, klr, vlr, beta, gamma)),
                  Node(Black, kr, vr, delta, epsilon)) 
     | putFixup(Node(Black, ka, va, 
             ...
             Node(Red, ka, va, 
                  ...
                  Node(Red, kr, vr, delta, epsilon)))
     | putFixup(Node(Black, ka, va, 
                     Node(Red, kl, vl, alpha, 
                                       Node(Red, klr, vlr, beta, gamma)), 
                     delta)) =
             Node(Black, klr, vlr, 
                  Node(Red, kl, vl, alpha, beta), 
